...
# Навык «Добыча» (Этап 4.22): сколько ресурса даёт один удар топором по узлу
# (resource_pickup.gd: hit). База 1; прокачивается очками навыков 1→2→3 в
# меню навыков (Этап 4.23). Как в оригинале — выше навык, больше за удар.
