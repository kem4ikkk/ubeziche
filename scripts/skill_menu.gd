...
## (ур. 1..3) → сигнатурная способность (верхний узел). Прокачка (правка
## 2026-06-17): ЛЮБАЯ ветка качается до SKILL_MAX (3); класс определяет только
## сигнатурную способность своей ветки (unlock_ability).
